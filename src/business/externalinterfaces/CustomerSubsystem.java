 ...
 * card, shopping cart. 
 * 
 * Note: createAddress method is implemented in the facade
 */
public interface CustomerSubsystem {
	/** 
	 * Used for loading order history,
	 * default addresses, default payment info, 
	 * saved shopping cart,cust profile
	 * after login. Also, customer's live cart items are
	 * transferred to the new ShoppingCartSubsystem that will
