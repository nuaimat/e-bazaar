    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-footer">${product.productName} for only $<span class="text-primary">${product.unitPrice}</span>
            <div style="text-align: center">
                <button class="btn btn-primary edit-product-btn" value="${product.productId}">Edit</button>
                <button class="btn btn-danger delete-product-btn" value="${product.productId}">Delete</button>
            </div>
        </div>
    </div>
</div>